...
static const int file_cfg_first_final = 278;
...
#line 5661 "cfg.c"
static const int cmd_cfg_start = 236;
static const int cmd_cfg_first_final = 236;
static const int cmd_cfg_error = 0;

static const int cmd_cfg_en_main = 236;
